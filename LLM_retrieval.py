...
def save_embeddings(obj, out_path):
    ...
    #out_path = out_path.replace('{}', type)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-l','--max_length', type=int, help='Maximum embedding size', default=4096)
    ...
    if args['model'] in ['intfloat/e5-mistral-7b-instruct', 'Salesforce/SFR-Embedding-Mistral']:
        ...
        if args['queries'] and args['task']:
            ...
            all_queries.append(torch.Tensor(q_rep))
        ...
        if args['documents']:
            ...
            all_docs.append(torch.Tensor(d_rep))
